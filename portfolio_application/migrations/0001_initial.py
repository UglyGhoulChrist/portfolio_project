    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('picture', models.FileField(blank=True, null=True, upload_to='media/', verbose_name='Картинка проекта')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('picture', models.FileField(blank=True, null=True, upload_to='media/', verbose_name='Картинка навыка')),
            ],
            options={
                'verbose_name': 'Навык',
