...
class Skill(models.Model):
    ...
    picture = models.FileField(verbose_name='Картинка навыка', upload_to='portfolio_application/img', null=True,
                               blank=True)
...
class Project(models.Model):
    ...
    picture = models.FileField(verbose_name='Картинка проекта', upload_to='portfolio_application/img', null=True,
                               blank=True)
